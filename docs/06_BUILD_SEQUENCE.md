...
- **Still NOT built:** file UI, upload, Storage bucket, signed URLs, scan jobs, AI extraction, RLS surfacing. RISK-002 + RISK-016 open; **cutover + onboarding stay blocked**. **Next: the `files` RLS PR (§5 of doc 16) with its own tests, default-deny until green.**
