...
## Merged PRs
**PRs #1–#53 are merged** (main @ `e6df89f`); **PR #54 (document full OMC legacy parity matrix — docs-only; adds doc 27, the row-level parity ledger under the doc 17 gate; **v3 is NOT OMC replacement-ready, implements nothing, does NOT close RISK-001 or authorize cutover**) is this PR.** The full
