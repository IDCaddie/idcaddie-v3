...
- **Prevention**: `scopesExactlyApproved` enforces the EXACT `["okta.users.read"]` set (no missing/extra/prohibited/duplicate); prohibited families are enumerated; the authorize builder and connect gate both enforce it.
