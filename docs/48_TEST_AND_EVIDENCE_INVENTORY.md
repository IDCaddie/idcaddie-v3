...
> **Posture (unchanged by this doc):** **RISK-007 remains OPEN. Phase C remains BLOCKED.** Nothing here closes RISK-007,
...
- **Governance:** **RISK-007 remains OPEN; Phase C remains BLOCKED** — closing/unblocking each is a **separate explicit approval**.
