...
// Error boundary for the access surface. Renders ONLY safe static copy + the Next-generated `digest` (a log-correlation hash, never the
// message/stack). Not-found is handled inline by each page (RLS/RPC-hidden id → generic "not found"), so no not-found.tsx is needed.
