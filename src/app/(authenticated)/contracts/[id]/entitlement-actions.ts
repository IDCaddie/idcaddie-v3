...
// live there, and 0084's AFTER trigger audits an accepted write. A `"use server"` module may export only async functions, so
// the imported types are erased.
//
// No authorization here. 0084's policies (read = the parent contract's visibility; write = tenant editor+ or the contract's
