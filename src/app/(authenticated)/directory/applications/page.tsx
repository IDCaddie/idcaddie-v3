    ...
    <DirectoryListPage
      ...
      footnote={
        <>
          ...
          contracts, spend and utilization. An application listed here does not need a matching SaaS record, and the absence of one is not a
          problem to fix — the two surfaces are not linked yet.
        </>
      }
    />
  );
